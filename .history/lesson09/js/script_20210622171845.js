...
fetch(requestURL)
  ...
  .then(function (jsonObject) {
    ...
    for (let i = 0; i < towns.length; i++ ) {
        ...
        section.textContent = jsonObject.filter(obj => obj.towns.name == "Soda Springs", "Preston", "Fish Haven" + ' ' + towns[i].motto + ' ' + towns[i].yearFounded + ' ' + towns[i].currentPopulation + ' ' + towns[i].averageRainfall);
